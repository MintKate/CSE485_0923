CREATE TABLE tacgia(
ma_tgia INT(3) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
ten_tgia VARCHAR(100) NOT NULL,
hinh_tgia VARCHAR(100)
)

CREATE TABLE theloai(
ma_tloai INT(3) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
ten_tloai VARCHAR(200) NOT NULL
)

CREATE TABLE baiviet(
ma_bviet INT(3) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY ,
