                    ...
                    <div class="form-login bg-secondary" id="form_login">
                        <form class="form-group-login" action="check_account.php" method="post">
                            ...
                            <div class="text-center c-warning" >
                                <hr> 
                                <p>Don't have an account? <a href="register.php" style="text-decoration: none; color: #FFC107;">Sign up</a></p>
                                <p><a href="#" style="text-decoration: none; color: #FFC107; ">Forgot your password?</a></p>
                            </div>
                        </form>
                    </div>
