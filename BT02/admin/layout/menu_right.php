<div class="col-md-2 menu-right rounded-start-5 d-flex align-items-center flex-column bg-white justify-content-between">
    ...
    <div class="languages">
        <div class="icon-Languages"><img src="./images/en.png"></div>
